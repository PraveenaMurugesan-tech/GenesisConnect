// ==============================================================================
// Genesis Power Equipments Pvt. Ltd. — Master Product Catalogue Data Layer
// Phase 3: Centralized, strongly-typed, API-ready equipment repository
// ==============================================================================
...
/**
 * CatalogueProduct extends base Product with rich marketing & application metadata
 */
...
/**
 * Standardized category list aligned with official Genesis product scope
 */
...
/**
 * Master Genesis Product Catalogue
 * Note: Specifications strictly follow client-provided data.
 * Unavailable technical parameters are explicitly marked "Not provided".
 */
export const PRODUCTS: CatalogueProduct[] = [
  {
    id: "genesis-ups-small-office",
    ...
    shortDescription: "High-efficiency online double-conversion UPS engineered for small offices, workstations, branch networking racks, and point-of-sale systems.",
  ...
  },
  {
    ...
    shortDescription: "Ruggedized industrial grade online double-conversion UPS built to withstand harsh electrical environments, harmonic distortion, and demanding industrial plant loads.",
  ...
  },
  {
    ...
    shortDescription: "Specialized high-capacity medical imaging UPS engineered to absorb severe momentary pulsed loads and deliver uninterrupted power to CT scan systems.",
  ...
  {
    id: "genesis-emi-filter-ultrasound",
    ...
    shortDescription: "Specialized medical grade electromagnetic interference (EMI/RFI) filter designed to eliminate high-frequency mains noise and distortion from ultrasound imaging.",
  ...
  },
  {
    ...
    shortDescription: "State-of-the-art solid-state static voltage stabilizer utilizing Insulated Gate Bipolar Transistor (IGBT) PWM technology for microsecond-fast voltage correction.",
  ...
  },
  {
    ...
    shortDescription: "Heavy-duty servo motor-controlled automatic voltage stabilizers delivering reliable line conditioning for industrial plants, factories, and commercial buildings.",
  ...
  },
  {
    ...
    shortDescription: "Precision Constant Voltage Constant Frequency (CVCF) static frequency converters delivering stable 50Hz, 60Hz, or 400Hz clean sinusoidal power.",
  ...
  },
  {
    ...
    shortDescription: "Ultra-high reliability medical UPS system specifically tailored for hospital Cath Labs, digital angiography, and fluoroscopic imaging suites.",
  ...
  {
    id: "genesis-custom-power-systems",
    ...
    shortDescription: "Custom-engineered power distribution, bespoke battery backup racks, outdoor weatherized enclosures, and specialized power conditioning solutions.",
...
// Helper Functions (maintained for data-layer consumption)
...
export const getProductBySlug = (slug?: string): CatalogueProduct | undefined => {
  ...
  return PRODUCTS.find((p) => p.slug.toLowerCase() === slug.toLowerCase() && p.isActive);
};
